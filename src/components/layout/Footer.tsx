      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            <Link href="/" className="flex flex-col">
              ...
              <span className="text-gray-400 font-medium text-sm tracking-widest uppercase mt-1">
                Bali
              </span>
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed">
              Premium scooter rental experience in Bali. Fast, reliable, and luxury service tailored for international tourists and digital nomads.
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <Link href="/scooters" className="text-gray-400 hover:text-white transition-colors">Our Fleet</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm">Jl. Raya Canggu No.88, Canggu, Bali 80361, Indonesia</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">hello@thebikerentalbali.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} THE BIKE RENTAL BALI. All rights reserved.
          </p>
          <div className="flex items-center gap-4 text-gray-500 text-sm">
            <span>Built for Premium Travel</span>
          </div>
        </div>
      </div>
    </footer>
