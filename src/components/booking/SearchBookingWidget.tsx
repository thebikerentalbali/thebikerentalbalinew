  ...
  return (
    <div className="glass-card rounded-3xl p-4 md:p-6 w-full shadow-2xl">
      <form onSubmit={handleSearch} className="flex flex-col lg:flex-row gap-4 items-center">
        ...
        <div className="flex-1 w-full grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-gray-50 dark:bg-[#1A1A1A] border-none rounded-2xl focus:ring-2 focus:ring-black dark:focus:ring-white outline-none transition-all text-sm font-medium"
        ...
        <Button 
          type="submit" 
          className="w-full lg:w-auto h-full min-h-[56px] px-8 rounded-2xl font-bold text-lg bg-black text-white hover:bg-gray-800 transition-all flex items-center justify-center gap-2"
        >
