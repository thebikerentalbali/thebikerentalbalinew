...
export default function DetailClientView({ id, initialScooter, initialVendor }: DetailClientViewProps) {
  const router = useRouter()
  
  const [scooter, setScooter] = useState<any>(initialScooter || null)
  const [vendor, setVendor] = useState<any>(initialVendor || null)
  const [loading, setLoading] = useState(!initialScooter)
